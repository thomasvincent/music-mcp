...
describe("Music MCP Server E2E Tests", () => {
  ...
  describe("Tool Registration - ListTools", () => {
    ...
    it("should have correct input schema for music_set_volume", async () => {
      const result = await client.listTools();
      const volumeTool = result.tools.find((t) => t.name === "music_set_volume");
    ...
    it("should have correct input schema for music_set_repeat", async () => {
      const result = await client.listTools();
      const repeatTool = result.tools.find((t) => t.name === "music_set_repeat");
  ...
  describe("Tool Handlers - Playback Control", () => {
    it("should handle music_play", async () => {
      ...
      const result = await client.callTool({ name: "music_play", arguments: {} });
    ...
    it("should handle music_pause", async () => {
      ...
      const result = await client.callTool({ name: "music_pause", arguments: {} });
    ...
    it("should handle music_stop", async () => {
      ...
      const result = await client.callTool({ name: "music_stop", arguments: {} });
    ...
    it("should handle music_next", async () => {
      ...
      const result = await client.callTool({ name: "music_next", arguments: {} });
  ...
  describe("Input Sanitization", () => {
    it("should escape double quotes in playlist names", async () => {
      ...
      // The double quotes are escaped multiple times due to shell escaping
      expect(mockedExecSync).toHaveBeenCalledWith(
